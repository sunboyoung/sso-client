package com.carl.auth.shiro.client.demo.model;

/**
 * @Author:zms
 * @Description:
 * @Date:Create On 2018/5/7 17:37
 */
...
public class User{
     ...
     * @mbg.generated  Fri Feb 17 15:34:04 CST 2017
     */
    private Integer id;
    /**
    ...
    /**
     *
     * @Created by ZYJ on 2017年2月20日 上午9:08:18
     * @return
     * @Version 1.0
     */
    @Override
    public String toString() {
        return "User [id=" + id + ", nickname=" + nickname + ", username=" + username + ", password=" + password + ", gender=" + gender + ", age="
                + age + ", phone=" + phone + ", create_time=" + create_time + ", last_online_time=" + last_online_time + ", status=" + status + "]";
    }
}